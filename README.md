...
**Versão atual:** 2.17.0.0 · FFXIV 7.51+ · Dalamud.NET.Sdk 15.0.0
...
- Aba **"Experimental"** nas Settings: agrupa opções de uso avançado ou instável (Listas de Coleta e Gear Wear Tracking) separadas das opções estáveis da aba General, com banner de aviso e sub-seções claramente rotuladas
