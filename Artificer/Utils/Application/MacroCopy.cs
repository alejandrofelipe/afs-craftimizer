...
public static class MacroCopy
{
    ...
    public static void Copy(IReadOnlyList<ActionType> actions, global::Artificer.Plugin.Plugin plugin)
    {
        if (actions.Count == 0)
        {
    ...
    private static void CopyToMacro(List<string> macros, global::Artificer.Plugin.Plugin plugin)
    {
    ...
    private static unsafe void SetMacro(int idx, bool isShared, string macroText, int macroIdx)
    {
        ...
        if (!macro->IsNotEmpty())
        {
            macro->Name.SetString($"Artificer Macro {macroIdx}");
    ...
    private static void CopyToClipboard(List<string> macros, global::Artificer.Plugin.Plugin plugin)
    {
    ...
    private static void CopyToMacroMate(string macro, global::Artificer.Plugin.Plugin plugin)
    {
